                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-12 pd_right_60">
                                <div class="section_title">
                                    ...
                                    <div class="title_whole">
                                        <h2 class="title">Nos consultants experts vous accompagnent au quotidie</h2>
                                    </div>

                                    <p>
                                        Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque
                                        laudanti totam aperiam eaquecy epsa abillo inventore veritatis architecto
                                        beatae
                                    </p>
                                </div>
                                <!---============spacing==========--->
                                    ...
                                    <ul class="list_box list">
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a class="links" href="#"> Best Insurance Agency </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a class="links" href="#"> Trusted &amp; Experience Insurance
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a class="links" href="#"> Dedicated Support &amp; Security
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-lg-4 col-md-8 mr_left_minus_40">
                                <div class="image_video_box_only type_two">
                                    <div class="image one">
                                        <img src="assets/images/about/about-4-1.png" alt="img"
                                            class="imf-fluid" />

                                        <div class="fun_facts type_two">
                                            <h6 class="title_no_a_18">25</h6>
                            ...
                            <div class="col-lg-2 col-md-4 pd_left_30">
                                <div class="fun_facts type_one text-start">
                                    ...
                                    <h6 class="title_no_a_18">Helath Insurance</h6>
                                </div>
                                <!---============spacing==========--->
                                    ...
                                    <div class="service_box type_five style_two icon_box_only type_three trans">
                                        <div class="icon_inner trans">
                                            <div class="d-flex trans">
                                                ...
                                                <div class="content">
                                                    <div class="title_22">
                                                        <a href="service.html">Medical
                                                            Insurance</a>
                                                    </div>
                                                    <p class="trans">
                                                        Additional benefits such as health check up, wellness…</p>
                                                    <a href="service.html" class="rd_more">
                                                        Read More
                                                        <svg width="14" height="12" viewBox="0 0 14 12"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M8 1L13 6M13 6L8 11M13 6H1"
                                                                stroke="var(--color-white)" stroke-width="1.5"
